    ...
    <footer>
      ...
      <div className="flex flex-col gap-2 lg:hidden mx-3">
        <div className="border-t border-b py-8 border-[#003c43] dark:border-[#757575] w-full flex flex-col items-center justify-center gap-5">
          {/** text */}
          <div className="">
            <h2 className="text-lg font-roboto font-medium">
          ...
          <div className="flex gap-5">
            <Link
              to=""
              className="flex items-center gap-2 text-sm font-roboto font-medium bg-[#003c43] text-white px-5 py-2 rounded-full"
            >
              Email
            ...
            <Link
              to=""
              className="text-sm font-roboto font-medium bg-[#e3e3e3] border border-[#003c43] text-[#003c43] px-5 py-2 rounded-full"
            >
              Linkedin
            </Link>
          </div>
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          <div className="flex gap-6">
            <Link
              to=""
              className="flex items-center font-mukta text-base font-medium gap-1"
            >
              <FaGithub />
              Github
            </Link>
          ...
          <div className="flex items-center gap-[2px]">
            <RiCopyrightLine />
            <h2 className="text-sm font-mukta font-bold">
      ...
      <div className="hidden lg:block mx-5">
        <div className="border-t border-b border-[#003c43] dark:border-[#757575] w-full flex items-center justify-center py-8">
          ...
          <div className="border-r-2 border-[#003c43] dark:border-[#757575] w-1/2 py-8">
            <div className="flex flex-col items-center justify-center gap-6">
              <h2 className="text-xl font-roboto font-medium text-[#333] dark:text-[#e3e3e3]">
                Let&apos;s connect for discussion
              </h2>
              <div className="flex items-center gap-8 font-medium font-mukta">
                <a
                  ...
                  target="_blank"
                  className="bg-[#003c43] flex items-center gap-1 w-fit px-6 py-2 rounded-full text-[#e3e3e3]"
                >
                  Email
                  <GoArrowUpRight />
                </a>
                <a
                  href="www.linkedin.com/in/sahil-ahmed-86222718a"
                  target="_blank"
                  className="border border-[#003c43] rounded-full px-5 py-2 bg-[#e3e3e3] text-[#003c43]"
                >
                  Linkedin
                </a>
              </div>
          ...
          <div className="w-1/2 py-8 flex items-center justify-center">
            <div className="flex">
              <a href="mailto:sahilahmed466@gmail.com" target="_blank">
              ...
              <a href="www.linkedin.com/in/sahil-ahmed-86222718a" target="_blank">
        ...
        <div className="mx-5 mt-4 mb-2 flex justify-between">
          <div className="flex flex-col gap-1">
            <h2 className="text-lg text-center font-kristi bg-black dark:border dark:border-white px-5 py-[1px] rounded-full text-white">
              --------- Sahil Ahmed ---------
            </h2>
          ...
          <div className="flex items-center justify-between gap-8">
            <Link
              to={"https://github.com/1999-sahil"}
              className="flex items-center font-mukta text-base font-medium gap-1"
            >
              <FaGithub />
              Github
            ...
            <Link
              to={"www.linkedin.com/in/sahil-ahmed-86222718a"}
              className="flex items-center font-mukta text-base font-medium gap-1"
            >
              <FaLinkedin />
              Linkedin
