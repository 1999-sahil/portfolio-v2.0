...
function MyWork() {
    return (
        <div className="relative mt-[500px] md:mt-[280px] lg:mt-[60px]">
            <h2 className="font-black font-candal text-5xl lg:text-4xl text-[#12372a] text-center mb-10 w-full">My Work</h2>
            ...
            <div className="px-8 lg:px-12 m-auto flex flex-col lg:flex-row gap-10">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-between">
                    ...
                    <span className='font-bold font-ubuntu mb-5 text-lg text-wrap whitespace-nowrap text-[#333333]'>
                    ...
                    <div className="flex flex-col items-center justify-center gap-4">
                        <img src={RightArrowImage} alt="" className="w-[150px] h-[150px] ml-20" />
                        <h2 className='font-extrabold text-xl font-dmsans text-gray-800 flex flex-col gap-2 items-center'>
                            Featured Project
