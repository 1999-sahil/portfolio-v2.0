  ...
  return (
    ...
    >
      <div className="overflow-hidden flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-neutral-200 dark:from-neutral-900 dark:to-neutral-800 to-neutral-100">
        <img src={header} alt="header" className="w-fit h-fit m-auto object-fill overflow-hidden" />
      </div>
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        <div className="text-xs dark:bg-[#333] w-fit px-2 p-1 rounded-full">
            {tag}
        </div>
        <div className="font-sans text-sm font-bold text-neutral-600 dark:text-neutral-200 mb-2 mt-2">
          {title}
        </div>
        <div className="font-sans text-sm font-normal text-neutral-600 text-xs dark:text-neutral-300">
          {description}
        </div>
      </div>
    </div>
