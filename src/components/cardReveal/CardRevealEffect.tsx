...
const Card = ({
  ...
  return (
    <div
      ...
      className="border gridBackground border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] max-w-sm w-full mx-auto p-4 lg:h-[30rem] rounded-3xl relative"
    >
  ...
  return (
    <div>
        <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs lg:text-lg font-roboto font-semibold leading-6  text-white inline-block">
            ...
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-900 dark:bg-zinc-800 py-0.5 px-4 ring-1 ring-white/10 ">
                <span>
                    {order}
                </span>
    <svg
